...
import cls.Mahasiswa;
import cls.MataKuliah;
import cls.Batch;
import cls.Kehadiran;
import cls.Pertemuan;
...
public class Main {
    public static void main(String[] xx) {
        ...
        for(Pertemuan x : daftarPertemuan){
			...
			System.out.print(", sakit "+x.hitungJumlahSakit());
			System.out.print(", izin "+x.hitungJumlahIzin());
